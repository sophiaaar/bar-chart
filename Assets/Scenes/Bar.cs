...
public class Bar : MonoBehaviour {
	...
	public void CreateBar(ParseData.Result result)
	{
		...
		blockedSlider.GetComponentInChildren<Text>().text = result.blocked.ToString();
		...
		failedSlider.GetComponentInChildren<Text>().text = result.failed.ToString();
		...
		passedSlider.GetComponentInChildren<Text>().text = result.passed.ToString();
	}
}
